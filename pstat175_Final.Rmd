...
We see in this summary output that the age interaction model shows a significant interaction between interval and age. The p-value of 0.04 is just below our significance threshold so we conclude that there is a significant interaction between the interval and age measurement. This tells us that \#############################################
