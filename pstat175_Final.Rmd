...
# would this be useful information to include?
```

The age interaction model shows a significant interaction between interval and age.
...
The sysbp interaction model does not show a significant interaction between interval and sysbp.
...
The stchange interaction model does not show a significant interaction between interval and stchange.
